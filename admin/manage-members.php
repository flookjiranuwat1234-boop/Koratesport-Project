    ...
    <div class="flex-1 ml-64 min-h-screen flex flex-col">
        ...
        <header class="bg-white border-b border-slate-200 px-8 py-4 flex items-center justify-between sticky top-0 z-40 shadow-sm">
            <div>
                ...
                <p class="text-xs text-slate-500 mt-0.5">ค้นหา ตรวจสอบบทบาท ระงับบัญชี และรีเซ็ตรหัสผ่านสมาชิก</p>
            </div>
            ...
            <div class="bg-white rounded-2xl border border-slate-200 p-5 shadow-sm">
                <form method="GET" id="memberSearchForm" class="flex flex-col md:flex-row gap-3">
                    <div class="flex-1 relative">
                        ...
                        <input type="text" name="q" id="memberSearchInput" placeholder="พิมพ์เพื่อค้นหาอัตโนมัติ... (ชื่อผู้ใช้ / อีเมล / ชื่อในเกม)" value="<?php echo htmlspecialchars($q); ?>" autocomplete="off"
                    ...
                    <?php if ($q !== '' || $roleFilter !== '' || $profileFilter !== ''): ?>
                            ...
                            <tr class="hover:bg-slate-50/80 transition-colors">
                                <td class="p-4 font-bold text-slate-900">
                                    <div class="flex items-center gap-2">
                                        ...
                                        <?php if ($m['player_id']): ?>
                                            <a href="../pages/player-profile.php?id=<?php echo $m['player_id']; ?>" target="_blank" class="hover:text-brand-orange transition-colors" title="ดูโปรไฟล์นักกีฬา">
                                ...
                                <td class="p-4 text-xs font-semibold">
                                    <?php if ($m['player_id']): ?>
                                        <a href="../pages/player-profile.php?id=<?php echo $m['player_id']; ?>" target="_blank"
                                            class="text-brand-orange hover:underline flex items-center gap-1.5 inline-flex">
